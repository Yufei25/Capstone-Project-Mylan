...
def test(request):
    contracts = Contract.objects.all()
    return render(request, 'test.html', {"contracts": contracts})
...
def contract_comment(request, contract_id):
    if not 'comment' in request.POST or not request.POST['comment']:
        ...
        return render(request, 'contract_comments.json', context, content_type='application/json')
...
def content_comment(request, content_id):
    if not 'comment' in request.POST or not request.POST['comment']:
        ...
        return render(request, 'content_comments.json', context, content_type='application/json')
...
def warning_comment(request, warning_id):
    if not 'comment' in request.POST or not request.POST['comment']:
        ...
        return render(request, 'warning_comments.json', context, content_type='application/json')
...
def get_contents_changes(request, contract_id, time="1970-01-01T00:00+00:00"):
    ...
    return render(request, 'contents.json', context, content_type='application/json')
...
def get_warnings_changes(request, contract_id, time="1970-01-01T00:00+00:00"):
    ...
    return render(request, 'warnings.json', context, content_type='application/json')
...
def get_changes(request, time="1970-01-01T00:00+00:00"):
    ...
    return render(request, 'contracts.json', context, content_type='application/json')
...
def get_current_contract(request, contract_id):
    ...
    print len(context['all_warnings'])
